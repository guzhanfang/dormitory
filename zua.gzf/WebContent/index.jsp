        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('个人信息','userupdate.jsp')">个人信息</a></dd>
              
              <dd><a href="login.html">切换账号</a></dd>
            </dl>
          </li>
      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li date-refresh="1">
                        <a _href="StudentListServlet?nowPage=1">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>学生列表</cite>
                        </a>
                    </li >
                    <li date-refresh="1">
                        <a _href="StudentDelListServlet?nowPage=1">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>删除列表</cite> 
                        </a>
                    </li >
