    ...
    <div class="x-body">
      <div class="layui-row">
        ...
        <c:choose>
			  ...
			  <c:otherwise>
			  	<input type="text" name="sid"  id = "sid" placeholder="请输入学生学号" autocomplete="off" class="layui-input" value="${requestScope.studentBean.sid }">
			  </c:otherwise>          	
          </c:choose>
          ...
          <c:choose>
			  ...
			  <c:otherwise>
			  	<input type="text" name="sentranceT"  id = "sentranceT" placeholder="请输入学生入学年份" autocomplete="off" class="layui-input" value="${requestScope.studentBean.sentranceT }">
			  </c:otherwise>          	
          </c:choose>
