      ...
      <div class="layui-row">
        ...
        <c:choose>
          ...
          <div class="layui-input-inline">
                   ...
                   <c:choose>
                   	<c:when test="${sessionScope.studentBean.ssex=='' }">
                   ...
                   <option type="checkbox" id="L_email"  value="" required="" 
	                autocomplete="off" class="layui-input">学生性别</option>
	            	 <option type="checkbox" id="L_email"  value="男" required="" selected="selected"
	                autocomplete="off" class="layui-input">男</option>
	                <option type="checkbox" id="L_email" value="女" required="" 
	                autocomplete="off" class="layui-input">女</option>
	                </c:when>
                   ...
                   <option type="checkbox" id="L_email"  value="" required="" 
	                autocomplete="off" class="layui-input">学生性别</option>
	            	 <option type="checkbox" id="L_email"  value="男" required="" 
	                autocomplete="off" class="layui-input">男</option>
	                <option type="checkbox" id="L_email" value="女" required="" selected="selected"
	                autocomplete="off" class="layui-input">女</option>
	                </c:when>
                   </c:choose>
	           	</select>
              </div>
         <!--  <input type="text" name="ssex"  id = "ssex" placeholder="请输入学生性别" autocomplete="off" class="layui-input" value="${sessionScope.studentBean.ssex }"> -->
